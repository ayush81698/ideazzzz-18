    ...
    <div className="py-10">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          >
            <Tabs defaultValue="model" className="h-[600px]">
          ...
          >
            ...
            <div className="flex items-center mb-4">
              ...
              <span className="text-muted-foreground">{product.rating} ({reviews.length} reviews)</span>
            </div>
            
            <div className="text-3xl font-bold text-ideazzz-purple mb-6">
            ...
            <div className="flex items-center space-x-4 mb-8">
              <div className="flex items-center border rounded-md">
                <button 
                  className="px-4 py-2 text-lg font-medium border-r"
                ...
                <button 
                  className="px-4 py-2 text-lg font-medium border-l"
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <Truck className="h-5 w-5 text-ideazzz-purple mr-3 mt-0.5" />
                <div>
                  <h3 className="font-medium">Free Shipping</h3>
                  <p className="text-sm text-muted-foreground">Free delivery across India for orders above ₹3,000</p>
                </div>
              </div>
              <div className="flex items-start">
                <Package className="h-5 w-5 text-ideazzz-purple mr-3 mt-0.5" />
                <div>
                  <h3 className="font-medium">Secure Packaging</h3>
                  <p className="text-sm text-muted-foreground">Special protective packaging ensures your model arrives in perfect condition</p>
                </div>
              </div>
              <div className="flex items-start">
                <RotateCcw className="h-5 w-5 text-ideazzz-purple mr-3 mt-0.5" />
                <div>
                  <h3 className="font-medium">Easy Returns</h3>
                  <p className="text-sm text-muted-foreground">30-day return policy if you're not completely satisfied</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <Tabs defaultValue="details">
            <TabsList className="w-full justify-start border-b rounded-none mb-6">
              ...
              <TabsTrigger value="reviews" className="rounded-none">Reviews ({reviews.length})</TabsTrigger>
              <TabsTrigger value="shipping" className="rounded-none">Shipping & Returns</TabsTrigger>
            </TabsList>
            ...
            {relatedProducts.map((relatedProduct, index) => (
              <Link to={`/shop/${relatedProduct.id}`} key={relatedProduct.id}>
                <Card className="overflow-hidden card-hover border-none shadow-md h-full">
                  <div className="h-[200px] relative bg-gradient-to-br from-ideazzz-purple/5 to-ideazzz-pink/5 overflow-hidden">
                    <img 
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-ideazzz-purple">₹{relatedProduct.price.toLocaleString()}</span>
                      <div className="flex items-center">
